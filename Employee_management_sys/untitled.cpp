...
void empdata(){
    int choice;
    cout<<"How many employees data do u want to enter??"<<endl;
    cin>>choice;
...
void search(){
    if(total!=0){
        string id;
        cout<<"Enter Id of data which u want to search"<<endl;
        cin>>id;
        for(int i =0;i<total;i++){
            if(id==e[i].id){
            cout<<"Data of employee"<<i+1<<endl;
...
void update(){
    if(total!=0){
        string id;
        cout<<"Enter Id of data which u want to Update"<<endl;
        cin>>id;
        for(int i =0;i<total;i++){
            if(id==e[i].id){
...
void del(){
    if(total!=0){
        ...
        if(userdel=='1'){
            ...
            string id;
            cout<<"Enter Id of data which u want to delete"<<endl;
            cin>>id;
            for(int i =0;i<total;i++){
                if(id==e[i].id){
